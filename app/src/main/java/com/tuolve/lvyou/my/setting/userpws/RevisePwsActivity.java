...
public class RevisePwsActivity extends BaseActivity {
    ...
    public int getLayoutId() {
        return R.layout.activity_revise_pws;
    }
    ...
    @OnClick({R.id.ib_back, R.id.my_tv_confirm})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.ib_back:
                onBackPressed();
                break;
            case R.id.my_tv_confirm:
                IntentUtil.startActivity(this,MyUserPwsActivity.class);
                break;
        }
    }
}
