 ...
 */
@RecyclerItemViewId(R.layout.tribe_outdoor_item)
public class TribeOutdoorHolder extends ModelRecyclerAdapter.ModelViewHolder {
    ...
    public TribeOutdoorHolder(View itemView) {
        super(itemView);
    }
