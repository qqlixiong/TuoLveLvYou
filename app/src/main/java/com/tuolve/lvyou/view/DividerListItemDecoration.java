...
public class DividerListItemDecoration extends RecyclerView.ItemDecoration
{
    ...
    private boolean isDrawEndLine;
    public static final int HORIZONTAL_LIST =
            LinearLayoutManager.HORIZONTAL;
    public static final int VERTICAL_LIST = LinearLayoutManager.VERTICAL;
    private Drawable mDivider;
    private int mOrientation;
    public DividerListItemDecoration(Context context, int orientation,boolean isDrawEndLine) {
        this.isDrawEndLine = isDrawEndLine;
...
// Log.e("recyclerview - itemdecoration", "onDraw()");
        if (mOrientation == VERTICAL_LIST) {
            if(isDrawEndLine){
                drawEndVertical(c,parent);
            }else {
                drawVertical(c, parent);
            }
        } else {
            if(isDrawEndLine){
                drawEndHorizontal(c,parent);
            }else {
    ...
    //垂直方向最后一个item画分割线
    public void drawEndVertical(Canvas c, RecyclerView parent) {
    ...
    //水平方向最后一个item画分割线
    public void drawEndHorizontal(Canvas c, RecyclerView parent) {
